...
**[GUIDE.md](./GUIDE.md)** - Instructions complètes étape par étape
...
1. **Installation** → [GUIDE.md](./GUIDE.md)
...
| Aspect | Détails |
|--------|---------|
| **Port** | 3011 (API + Socket.IO + Swagger) |
...
**Pour des instructions détaillées** : [GUIDE.md](./GUIDE.md)
