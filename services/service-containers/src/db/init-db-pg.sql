-- ============================================
-- Initialisation base PostgreSQL + PostGIS
-- ============================================
-- Exécuter la création de base avec un rôle ayant les droits appropriés.
-- Si la base existe déjà, supprimez la ligne suivante ou adaptez-la.
