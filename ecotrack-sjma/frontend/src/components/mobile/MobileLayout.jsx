...
export default function MobileLayout({ children, title, showBack = false, onBack, rightAction, greeting, greetingDate }) {
  const { user } = useAuth();
  ...
  return (
    <div className="mobile-layout">
      <MobileHeader title={title} showBack={showBack} onBack={onBack} rightAction={rightAction} greeting={greeting} greetingDate={greetingDate} />
