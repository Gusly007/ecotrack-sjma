...
// Stricter limit for bulk notification creation (expensive DB writes)
const bulkLimiter = rateLimit({
  ...
  message: {
    success: false,
    statusCode: 429,
    message: "Trop d'envois en masse. Limite : 10/min.",
    retryAfter: Math.ceil(WINDOW_MS / 1000)
  },
  standardHeaders: true,
  legacyHeaders: false,
...
module.exports = { generalLimiter, bulkLimiter };
