...
describe('Analytics Aggregation Routes Integration', () => {
  ...
  describe('GET /api/V1/analytics/aggregations', () => {
    ...
    it('should return aggregated data for day period', async () => {
      const res = await request(app)
        .get('/api/V1/analytics/aggregations?period=day')
        .set('Authorization', authToken);
      expect([200, 500, 401]).toContain(res.status);
    });
  ...
  describe('POST /api/V1/analytics/aggregations/refresh', () => {
  ...
  describe('GET /api/V1/analytics/aggregations/zones', () => {
  ...
  describe('GET /api/V1/analytics/aggregations/agents', () => {
    it('should return agent performances with valid dates', async () => {
      const res = await request(app)
        .get('/api/V1/analytics/aggregations/agents?startDate=2026-01-01&endDate=2026-12-31')
        .set('Authorization', authToken);
      expect([200, 500, 401]).toContain(res.status);
    });
